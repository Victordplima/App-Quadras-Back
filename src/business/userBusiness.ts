...
export const registrarUsuario = async (nome: string, email: string, senha: string, telefone: string, matricula: string, curso: string, role: string) => {
...
export const editarUsuario = async (id: number, nome: string, email: string, telefone: string, matricula: string, curso: string, role: string) => {
